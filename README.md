...
## V25.4 status
- Code polish applied on top of V25.3.
- Reference canvas and hitboxes now share one transform.
- Duplicate game completion is guarded centrally.
- Animals has per-level progress.
- Onboarding avatar/color selections expose the selected check.
- Full Expo install/build still requires verification in Codespaces.
