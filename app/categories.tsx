...
return <ArtworkScreen source={require('../assets/categories-reference.png')} sourceW={350} sourceH={570} starBox={{x:269,y:32,w:72,h:30}} targets={targets.map(([id,x,y,w,h,path])=>({id:String(id),rect:{x:+x,y:+y,w:+w,h:+h},path:String(path)}))}/>}
