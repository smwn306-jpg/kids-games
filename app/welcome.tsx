...
export default function Welcome(){
  ...
  const canvasW = W * scale, canvasH = H * scale;
  const ox = (width - canvasW) / 2, oy = (height - canvasH) / 2;
  ...
  return (
    <View style={s.root}>
      <Animated.Image
        ...
        resizeMode="stretch"
        style={[{position:'absolute',left:ox,top:oy,width:canvasW,height:canvasH}, { opacity: artworkOpacity, transform: [{ scale: artworkScale }] }]}
        accessible
