...
export default function Music(){
  ...
  return <GameShell title="מוזיקה וקצב" icon={require('../../assets/icon-music.png')} score={input.filter((x,i)=>x===seq[i]).length} total={seq.length} voiceText="הקשיבו וזכרו את הקצב, ואז חזרו עליו." >
