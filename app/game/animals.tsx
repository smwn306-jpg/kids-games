...
export default function Animals() {
  ...
  const { completeLevel, completeGame, voiceEnabled } = useAppProgress();
  ...
  const choose = (answer: string) => {
    ...
    if (answer === 'פיל') {
      ...
      completeLevel('animals',levelNo,1);
      if(levelNo===12) completeGame('animals',3);
      setAnswered(true);
    } else {
  ...
  return (
    <ArtworkScreen
      source={require('../../assets/animals-reference-clean-ui.png')}
      sourceW={W}
      sourceH={H}
