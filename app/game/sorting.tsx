...
const items=[
  ...
  ['תפוח','פירות',require('../../assets/icon-colors.png')],
  ['פיל','חיות',require('../../assets/animal-elephant.png')],
  ['בננה','פירות',require('../../assets/icon-animals.png')],
...
export default function Sorting(){
  ...
  const tap=(x:string)=>{
    ...
    if(i===items.length-1){completeGame('sorting',n===items.length?3:n>=3?2:1);setDone(true)}
    else setI(v=>v+1);
  };
  const item=items[i];
