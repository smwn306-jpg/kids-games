...
<View pointerEvents="none" style={{position:'absolute',left:101*sx,top:300*sy,width:119*sx,height:40*sy,borderRadius:10,backgroundColor:'#742fb7',zIndex:20}}><Text style={{color:'#fff',textAlign:'center',fontWeight:'900',fontSize:24*Math.min(sx,sy),lineHeight:36*sy}}>{String(name||'')}</Text></View>
