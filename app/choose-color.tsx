...
export default function ChooseColor(){
  ...
  return <View style={s.root}>
    <View pointerEvents="none" style={{position:'absolute',left:layout.offsetX,top:layout.offsetY,width:layout.canvasWidth,height:layout.canvasHeight}}><Image source={require('../assets/color-reference.png')} style={StyleSheet.absoluteFillObject} resizeMode="stretch"/></View>
