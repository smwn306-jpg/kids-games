...
return <View style={styles.root}><Image source={require('../assets/home-screen-source.png')} resizeMode="stretch" style={StyleSheet.absoluteFillObject} pointerEvents="none"/>
