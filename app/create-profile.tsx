...
export default function CreateProfile() {
  ...
  return (
    <View style={[s.root, { width, height }]}>
      <View pointerEvents="none" style={[s.canvas, { width: canvasWidth, height: canvasHeight }]}>
        <Image
      ...
      <TextInput value={name} onChangeText={setName} placeholder="השם שלי" placeholderTextColor="#a6a6c7" style={[s.input, rect(25, 165, 239, 48), { fontSize: 22 * Math.min(scaleX, scaleY) }]} textAlign="center" maxLength={16} autoFocus returnKeyType="next" onSubmitEditing={goNext} />
...
const s = StyleSheet.create({
  ...
  canvas: { position: 'absolute', left: 0, top: 0, overflow: 'hidden' },
