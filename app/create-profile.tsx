  ...
  return (
    <View style={s.root}>
      ...
      <Pressable
        ...
        accessibilityLabel="שמעו איך למלא את השם"
        style={[rect(112, 236, 66, 66), s.touchLayer]}
        onPress={() => speakHebrew('איך קוראים לך? כתבו את השם שלכם בתיבה.', voiceEnabled)}
      />
      ...
      <TextInput
        ...
        placeholder="השם שלי"
        placeholderTextColor="#a6a6c7"
        style={[s.input, rect(25, 165, 239, 48), { fontSize: 22 * layout.scale }]}
        textAlign="center"
        maxLength={16}
        autoFocus
        returnKeyType="next"
      ...
      <Pressable
        ...
        style={[rect(5, 8, 48, 48), s.touchLayer]}
        onPress={() => router.back()}
      >
        <Text style={s.hiddenText}>חזרה</Text>
      </Pressable>
    </View>
  );
}
